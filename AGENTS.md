...
- DevTools CLI 部署云函数: `& "F:\微信web开发者工具\cli.bat" cloud functions deploy --project "F:\molispark\摩力创境" --env cloud1-d6g0v8u009ac081c2 --names <函数名> --remote-npm-install`
- 绕过 project.config 解析: `& "F:\微信web开发者工具\cli.bat" cloud functions deploy --appid wx94825420d37a7652 --env cloud1-d6g0v8u009ac081c2 --paths "F:\molispark\摩力创境\cloudfunctions\<name>" --remote-npm-install`
- 页面配置校验: `npm --prefix "F:/molispark/摩力创境" run validate:pages`
