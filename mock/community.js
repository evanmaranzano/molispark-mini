const posts = [
  ...
  },
  {
    ...
    content: [
      ...
      'Sam Altman 回应表示同意需要为前沿 AI 发展设定节奏，称 OpenAI 也将开放独立评估者访问。',
      '来源：Dario Amodei《We Must Pace the Frontier》、Sam Altman 公开回应。',
    ],
  ...
  },
  {
    ...
    desc: '解析 Agent harness 层应对长任务上下文溢出与目标丢失的四类机制。',
    author: 'MarkTechPost',
    time: '今天',
    category: 'AI 工具',
    type: '日报',
...
const activities = [
  ...
  },
  {
    ...
    quota: 0,
    signupCount: 36,
    cover: 'cloud://cloud1-d6g0v8u009ac081c2.636c-cloud1-d6g0v8u009ac081c2-1471977670/images/activities/moli-salon-3.jpg',
    coverStyle: 'ai',
